...
type B2ContextVisitor interface {
    VisitB2(ctx IB2Context, delegate antlr.ParseTreeVisitor, args ...interface{}) (result interface{})
}
type C1ContextVisitor interface {
    VisitC1(ctx IC1Context, delegate antlr.ParseTreeVisitor, args ...interface{}) (result interface{})
}
type DContextVisitor interface {
    VisitD(ctx IDContext, delegate antlr.ParseTreeVisitor, args ...interface{}) (result interface{})
}